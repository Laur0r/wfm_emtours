...
import org.camunda.bpm.emtours.FunsparkController;
...
public class AddExecutionListenerToParser implements BpmnParseListener {

	@Override
	public void parseProcess(Element processElement, ProcessDefinitionEntity processDefinition) {
		processDefinition.addBuiltInListener(PvmEvent.EVENTNAME_START, new FunsparkController());
			processDefinition.addBuiltInListener(PvmEvent.EVENTNAME_END, new FunsparkController());
	}
	...
	public void parseExclusiveGateway(Element exclusiveGwElement, ScopeImpl scope, ActivityImpl activity) {
		activity.addBuiltInListener(PvmEvent.EVENTNAME_START, new FunsparkController());
	}
