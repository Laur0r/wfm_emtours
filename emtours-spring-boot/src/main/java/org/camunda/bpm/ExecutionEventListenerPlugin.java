 ...
 */
@Component
public class ExecutionEventListenerPlugin extends AbstractProcessEnginePlugin {
	...
	public void preInit(ProcessEngineConfigurationImpl processEngineConfiguration) {
		...
		processEngineConfiguration.getCustomPostBPMNParseListeners().add(new AddExecutionListenerToParser());
